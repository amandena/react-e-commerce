import { Facebook, Instagram, LinkedIn, MailOutline, Room, Phone, Twitter } from '@material-ui/icons'
  ...
  return (
    <Container>
      ...
      <Right>
        ...
        <ContactItem>
          <MailOutline style={{marginRight:"10px"}} /> contact@ringsnthingsbyamanda.com
        </ContactItem>
